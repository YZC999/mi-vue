 <template>
  <div class="xm-top-sub">
      <div class="xm-top-sub-son"> 
		<div class="sub-1">
			<ul class="channels">
				<li class="channel">
...
<script>
import ss from "../assets/style/font-awesome-4.7.0/css/font-awesome.min.css"
export default {
	data () {
		return {
		}
...
.channel:hover .channel-txt {
	color: #fff;
}
.channel:hover	.sub-icon {
	 color: #fff;
}
